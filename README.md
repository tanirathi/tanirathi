...
<p align="left">
  Generative AI • Agentic AI • LLM Applications • RAG •
  Multi-Agent Systems • AI Automation • Machine Learning •
  Cloud AI • AI Engineering
</p>
...
<ul>
  ...
  <li>
    <b>Agentic AI & GEO Platform</b><br>
    AI-powered solution using Research, Memory and Gap Analysis agents
  ...
  <li>
    <b>Multimodal Content Generation Platform</b><br>
    Agentic AI solution using Amazon Bedrock, RAG, Knowledge Bases,
    OpenSearch and AWS services for personalized content generation.
  </li>

  <br>

  <li>
    <b>RAG-Based Intelligent Chatbot</b><br>
    Context-aware chatbot built using LangChain, FAISS, embeddings
    and LLM APIs.
  </li>
